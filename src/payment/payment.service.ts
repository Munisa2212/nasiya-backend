...
export class PaymentService {
  ...
  //         const payment_schedule = await tx.payment_schedule.findFirst({
  //           where: {
  ...
  //           throw new BadRequestException('Payment already made for this date');
  //         }

  //         if(amount > credit.monthly_payment_amount){
  ...
  //               data: {
  //                 paid_amount: {
  //                   increment: credit.monthly_payment_amount,
  //                 },
  //               },
  //           });
  ...
  //             data: {
  //               remaining_amount: {
  //                 decrement: credit.monthly_payment_amount,
  //               },
  //             },
  //           });

  //           amount -= credit.monthly_payment_amount
  //         }else if(amount < credit.monthly_payment_amount){
  //           await tx.payment_schedule.update({
  //             where: {
  //               credit_id_due_date: {
  //                 credit_id: createPaymentDto.credit_id,
  ...
  //         const updated_schedule = await tx.payment_schedule.findFirst({
  //           where: {
  //             credit_id: createPaymentDto.credit_id,
  //             due_date: new Date(date),
  //           },
  ...
  //         if (
  //           updated_schedule &&
  //           updated_schedule.paid_amount == updated_schedule.expected_amount
  //         ) {
  //           await tx.payment_schedule.update({
  //             where: {
  //               credit_id_due_date: {
